...
#Region " Business Properties and Methods "
        ...
        <CellInfo("pbs.BO.PM.CRT", Tips:="Enter contract number")>
        ...
        Public Property Weigh() As String
            ...
            End Get
            Set(ByVal value As String)
                CanWriteProperty("Weigh", True)
                If value Is Nothing Then value = String.Empty
                If Not _weigh.Equals(value) Then
                    _weigh.Text = value
                    PropertyHasChanged("Weigh")
                End If
            End Set
        End Property
...
#Region " Data Access "
        ...
        Private Sub FetchObject(ByVal dr As SafeDataReader)
            ...
            _weigh.Text = dr.GetDecimal("WEIGH")
        ...
        Private Sub AddInsertParameters(ByVal cm As SqlCommand)
            ...
            cm.Parameters.AddWithValue("@WEIGH", _weigh.DBValue)
