...
#Region " Business Properties and Methods "
    ...
    <CellInfo("pbs.BO.PM.PRJ", Tips:="Enter project code")>
    ...
    Public Property PerformTo() As String
        Get
            Return _performTo.Text
        End Get
        Set(ByVal value As String)
            CanWriteProperty("PerformTo", True)
            If value Is Nothing Then value = String.Empty
            If Not _performTo.Equals(value) Then
                _performTo.Text = value
                PropertyHasChanged("PerformTo")
            End If
        End Set
    End Property
...
#Region " Data Access "
    ...
    Private Sub AddInsertParameters(ByVal cm As SqlCommand)
        ...
        cm.Parameters.AddWithValue("@PERFORM_TO", _performTo.DBValue)
